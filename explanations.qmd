...
For the remainder of this paper we use the following notation\footnote{This
...
relative feature importance for linear models\footnote{See
...
\cite{janzing_feature_2019} are honing in on when they argue that the use of an
...
indicating that $X_1$ is a causal ancestor of $X_2$. In \textbf{Distal
...
causes. Alternatively, \textbf{Proximate Asymmetric Shapley Values} (p-ASV)
