...
methods can be unified by considering the different choice of \textit{reference
distribution} used to simulate feature removal. Their notion of a reference
distribution is roughly analogous to RBShap. They also introduce the idea of
\textit{single reference games}, which simulates feature absence by replacing
...
reasoning is required to assess model fairness\footnote{More specifically, they
